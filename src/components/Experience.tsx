...
const experiences: ExperienceItem[] = [
  {
    ...
    period: "2023 — Present",
    description: [
      "Built and maintained distributed metadata and dataplane components for cloud object storage in a large-scale production environment.",
      "Implemented and validated backend API flows for object lifecycle operations, pagination behavior, and error-handling paths.",
      "Improved integration-test reliability and local reproducibility using Maven, JUnit/TestNG, and CI failure triage workflows.",
      "Contributed to infrastructure automation and deployment tooling with Terraform to support consistent multi-region rollouts.",
    ],
    tags: [
      "Java",
      "Go",
